...
<div class="form-curriculos form">

	<?php if(@$_GET['msg']==1){ ?>

	<div class="row"><div class="col-md-12"><div class="alert alert-success" style="text-align:center; color: #3c763d;">Curriculo cadastrado com sucesso!</div></div></div>	

	<?php }elseif(@$_GET['msg']==2){ ?>

	<div class="row"><div class="col-md-12"><div class="alert alert-success" style="text-align:center; color: #3c763d;">Curriculo Atualizado com sucesso!</div></div></div>	

	<?php }elseif(@$_GET['msg']==3){ ?>

	<div class="row"><div class="col-md-12"><div class="alert alert-success" style="text-align:center; color: #3c763d;">Conta excluido com sucesso!</div></div></div>	
		...
		<div id="dadosPessoais">
			...
			<div class="row">
				<div class="col-md-7">
					<div class="form-group">
						<div class="controls">
							<input type="text" name="nome" class="form-control" value="<?php echo @$dadosF['nome']?>" placeholder="nome" required="required"/> 
						</div>
					</div>
				</div>
				<div class="col-md-5">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<div class="controls">
							<input type="text" name="telefone" id="telefone" value="<?php echo @$dadosF['telefone']?>" class="form-control" id="telefone" placeholder="telefone" required="required"/>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						<div class="controls">
							<input type="text" name="celular" value="<?php echo @$dadosF['celular']?>" class="form-control" id="celular" placeholder="celular" required="required"/>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="controls">
					<input type="email" name="email" value="<?php echo @$dadosF['email']?>" class="form-control" placeholder="e-mail" required="required"> 
				</div>
			</div>
...
<div id="conhecimentoTecnico" style="display:none;">
	...
	<div class="row">
		<div class="col-md-12">
			<button type="submit" id="cadastrar" name="cadastrar" class="btn btn-primary pull-right">Cadastrar Currículo</button>
			<a href="#" class="btn btn-success prev-step">Etapa anterior</a>
		</div>
	</div>
</div>
